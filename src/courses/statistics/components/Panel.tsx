...
/**
 * Collapsible section card used across the statistics-course lessons. With a
 * `title` it toggles open/closed; title-less panels render as a plain card.
 * (Same pattern as the semiconductors/algorithms courses.)
 */
