...
import ExpectationTab from './tabs/ExpectationTab'
import VarianceTab from './tabs/VarianceTab'
import CharFuncTab from './tabs/CharFuncTab'
import PracticeTab from './tabs/PracticeTab'

type TabId = 'intro' | 'expectation' | 'variance' | 'charfunc' | 'practice'

const TABS: { id: TabId; labelHe: string; icon: string }[] = [
  { id: 'intro', labelHe: 'מבוא — מספרים שמסכמים', icon: '📘' },
  { id: 'expectation', labelHe: 'תוחלת', icon: '⚖️' },
  { id: 'variance', labelHe: 'שונות ומתאם', icon: '📊' },
  { id: 'charfunc', labelHe: 'פונקציה אופיינית', icon: '🌐' },
  { id: 'practice', labelHe: 'תרגול', icon: '✏️' },
]

const PANELS: Record<TabId, React.FC> = {
  intro: IntroTab,
  expectation: ExpectationTab,
  variance: VarianceTab,
  charfunc: CharFuncTab,
  practice: PracticeTab,
}

const isTab = (v: string | null): v is TabId => TABS.some((t) => t.id === v)

/** Lesson 2 page: five tabs building the moments of a distribution
 *  (deep-linked via ?tab=). */
export default function MomentsExplainer() {
