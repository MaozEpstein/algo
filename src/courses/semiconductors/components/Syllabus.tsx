...
const LESSONS: SyllabusLesson[] = [
  ...
  },
  {
    ...
    parts: [
      {
        label: 'חלק א׳ · מבנה ופעולה',
        desc: 'תעלת $n$ בין מקור לניקוז ושני שערי $p^+$; דלדול התעלה ע״י $V_{GS}$ ומתח-הצביטה $V_P$; צביטה מודרגת ע״י $V_{DS}$ ומעבר מאזור אוהמי לרוויה ($V_{Dsat}=|V_P|-|V_{GS}|$); שלושת מצבי-הפעולה.',
        done: true,
      },
      {
        label: 'חלק ב׳ · אופיינים, MESFET ואות-קטן',
        desc: 'אופייני $I_D(V_{DS})$ ו-$I_D(V_{GS})$ (חוק ריבועי, $I_{DSS}$), MESFET (שער שוטקי), ומוליכות-המעבר $g_m$.',
        done: false,
      },
    ],
  },
