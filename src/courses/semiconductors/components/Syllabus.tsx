...
const LESSONS: SyllabusLesson[] = [
  ...
  },
  {
    ...
    title: 'דיודת PN',
    parts: [
      { label: 'דיודה אידיאלית', desc: 'גזירת אופיין הדיודה $I=I_S(e^{qV/kT}-1)$ וזרם הרוויה $I_S$.', done: true },
      { label: 'דיודה לא-אידיאלית', desc: 'זרם רקומבינציה/גנרציה, הזרקה חזקה, התנגדות טורית, ומקדם אי-אידיאליות $n$.', done: true },
      { label: 'דיודת שוטקי', desc: 'צומת מתכת-מל"מ מיישר — מחסום שוטקי.', done: true },
