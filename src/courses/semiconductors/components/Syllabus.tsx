...
const LESSONS: SyllabusLesson[] = [
  ...
  },
  {
    ...
    parts: [
      ...
      { label: 'חלק ד׳ · מגע מתכת-מל"מ (אוהמי)', desc: 'מגע לא-מיישר, לחיבור ההתקן למעגל בלי דיודה טפילית.' },
    ],
  },
  {
    n: 'שיעור 3',
    ...
    parts: [
      {
        ...
        desc: 'npn/pnp, שלושת האזורים (פולט/בסיס/אספן), הטיית הצמתים (EB קדמי, CB אחורי), שלושת מצבי-הפעולה (פעיל/רוויה/קטעון), ולמה הטרנזיסטור מגביר. דיאגרמת פסים של שני צמתים ופרופיל מיעוט לאורך E-B-C.',
      },
      {
        label: 'חלק ב׳ · זרמים והגבר',
        desc: 'גזירת רכיבי הזרם מהפרופילים, מקדמי ההגבר $\\alpha$ ו-$\\beta$, יעילות ההזרקה ומקדם מעבר הבסיס, אופייני המוצא $I_C(V_{CE})$, ומודל Ebers-Moll.',
      },
      {
