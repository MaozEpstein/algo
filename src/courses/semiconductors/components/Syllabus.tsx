    ...
    parts: [
      {
        ...
        desc: 'מבנה M-O-S והשוואה לקבל-לוחות; דיאגרמת-הפסים, הפרש פונקציות-העבודה $\\phi_{MS}$ ומתח flat-band $V_{FB}$; שלושת המשטרים — הצטברות, דלדול ($W=\\sqrt{2\\varepsilon_s\\psi_s/qN_A}$) והיפוך — עם דיאגרמת-פסים, פרופיל-מטען וסכמת-שכבות, וארגז-חול אינטראקטיבי.',
        done: true,
      },
      {
        label: 'חלק ב׳ · מתח-סף, C-V ומטעני-אוקסיד',
        desc: 'מתח-הסף $V_T=V_{FB}+2\\phi_F+Q_{dep,max}/C_{ox}$, אופיין ה-$C$-$V$ (תדר נמוך/גבוה/דלדול-עמוק), ומטעני-תחמוצת ($Q_{it},Q_f,Q_{ox}$) והשפעתם על $V_{FB}/V_T$.',
        done: false,
      },
    ],
  },
