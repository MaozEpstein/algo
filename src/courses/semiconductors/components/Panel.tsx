...
/**
 * Collapsible card used across the semiconductors-course tabs. With a `title`
 * it toggles open/closed; title-less panels render as a plain card. (Same
 * pattern as the algorithms-course lectures.)
 */
