...
export const bjtStructureLecture: LectureModule = {
  ...
  glossary: [
    ...
    { term: 'רכיבי-הזרם בדיאגרמת-הפסים', def: 'בפעיל-קדמי: $J_e$ — זרם האלקטרונים שהפולט מזריק וחוצה את הבסיס; $J_{ec}$ — אותם אלקטרונים הנאספים בקולט (≈ זרם-הקולט); $J_R$ — רקומבינציה בבסיס (אלקטרונים יורדים וחורים עולים, נפגשים); $J_h$ — הזרקת-חורים נגדית מהבסיס לפולט. $J_R$ ו-$J_h$ מרכיבים את זרם-הבסיס הקטן. הכימות המלא — ב-3ב.' },
  ],
  formulas: [
  ...
  symbols: [
    ...
    { sym: 'J_e', he: 'זרם האלקטרונים שהפולט מזריק (הזרקה←דיפוזיה←קליטה)', unit: 'A/cm^2' },
    { sym: 'J_{ec}', he: 'זרם האלקטרונים הנאסף בקולט (≈ זרם-הקולט)', unit: 'A/cm^2' },
    { sym: 'J_R', he: 'זרם הרקומבינציה בבסיס (אלקטרונים וחורים נפגשים) — חלק מ-$I_B$', unit: 'A/cm^2' },
    { sym: 'J_h', he: 'זרם החורים המוזרק נגדית (בסיס←פולט) — חלק מ-$I_B$', unit: 'A/cm^2' },
  ],
}
