      ...
      <Panel title="מה ההבדל המהותי?">
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div className="rounded-xl border-s-4 border-violet-300 bg-violet-50/50 p-3 text-sm leading-relaxed text-slate-700">
            <b>בקבל-MOS</b> צד המתכת עדיין יריעת-מטען, אך בצד המוליך-למחצה המטען <b>מתפרש על רוחב-מחסור</b> —
            ולכן השדה קבוע באוקסיד אך <b>דועך</b> לאורך אזור-המחסור. בדיוק כאן נכנס משטר-הפעולה.
          </div>
        </div>
