...
export default function SummaryTab() {
  return (
    <div className="flex flex-col gap-5">
      ...
      <Panel title="מה הלאה?">
        <p className="leading-relaxed text-slate-600">
          בנינו את הצומת ב<b>שיווי משקל</b>. בחלק ב' — <b>הדיודה במתח</b> — נראה מה קורה כשמפעילים מתח חיצוני:
          המחסום יורד או עולה, נושאי מיעוט מוזרקים, ומתקבל האופיין המעריכי <Tex>{'I=I_0(e^{qV/kT}-1)'}</Tex>.
