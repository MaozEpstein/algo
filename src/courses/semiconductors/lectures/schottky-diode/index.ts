...
export const schottkyDiodeLecture: LectureModule = {
  ...
  glossary: [
    ...
    { term: 'זיקה אלקטרונית $\\chi$', def: 'האנרגיה מקצה פס ההולכה $E_c$ של המל"מ עד לרמת הוואקום.' },
    ...
    { term: 'הנמכת מחסום בכוח-דמות', def: 'השדה החשמלי מנמיך מעט את $\\varphi_B$ ($\\Delta\\varphi_B\\propto\\sqrt{E_{max}}$) — לכן הזרם האחורי אינו רווי לחלוטין.' },
  ],
  formulas: [
